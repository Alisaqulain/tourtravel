...
const marketplaceNav = [
  { href: '/admin/marketplace/hotels', label: 'Marketplace Hotels', icon: Store },
  { href: '/admin/marketplace/payouts', label: 'Payouts', icon: Wallet },
  { href: '/admin/marketplace/commission', label: 'Commission', icon: Percent },
  { href: '/admin/marketplace/bookings', label: 'Marketplace Bookings', icon: FileText },
];
      ...
      <aside className="hidden md:flex w-64 flex-col border-r border-border bg-card">
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto" role="navigation" aria-label="Admin menu">
          ...
          <div className="pt-4 mt-4 border-t border-border">
            <p className="px-4 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Marketplace</p>

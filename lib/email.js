...
const FROM_EMAIL = process.env.SMTP_MAIL_FROM || 'Triptotravelsofficial@gmail.com';
const APP_PASSWORD = process.env.SMTP_APP_PASSWORD || process.env.GMAIL_APP_PASSWORD;
